<%-- 
    Document   : ConsultasPredio
    Created on : 29-nov-2019, 17:40:25
    Author     : Alex
--%>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <p>Sección Consultas Prediales</p>
                <li class="active">
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Menú</a>
                    <ul class="collapse list-unstyled" id="homeSubmenu">

                        <li><a href="IngresoConsulta.jsp" title=" "style="color: white">Consulta</a></li>
