...
public final class IngresoPlanDeManejo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    cnx.getConnection();
      ...
      out.write("        \n");
      out.write("        <title>Plan de Manejo</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <form action=\"\" metod=\"\">\n");
...
out.print(session.getAttribute("Tipo"));
      ...
      out.write("                            <h3>Registro Plan de Manejo:</h3>\n");
      out.write("                        </td>\n");
      out.write("                    </tr>\n");
      out.write("\n");
      out.write("                    <tr valign=\"top\"> \n");
      out.write("                        <td>Estudio Técnico:</td>\n");
      out.write("                        <td>\n");
      out.write("                            <select name=\"estudiotecnico\" style=\"width: 250px\" class=\"form-control\">\n");
      out.write("                                <option  value='-1'>Seleccione tipo de estudio</option>\n");
      out.write("                                ");
ResultSet puntero = cnx.EntregaDatos("SELECT Id_TipoPlanDeManejo,EstudioTecnico FROM TipoPlanDeManejo");
      ...
      out.write("\n");
      out.write("                    <tr>\n");
      out.write("                        <td><div class=\"tituloChico\">Marco Legal:</div></td>\n");
      out.write("                        <td> \n");
      out.write("                            \n");
      out.write("                             <select name=\"marcolegal\" style=\"width: 250px\" class=\"form-control\">\n");
      out.write("                                <option  value='-1'>Seleccione Marco Legal</option>\n");
      out.write("                                ");
ResultSet mlegal = cnx.EntregaDatos("SELECT Id_TipoPlanDeManejo,MarcoLegal FROM TipoPlanDeManejo");
                                    while (mlegal.next()) {
                                        out.println("<option value='" + mlegal.getInt(1) + "'>" + mlegal.getString(2) + "</option>");
                                    }
      ...
      out.write("                    \n");
      out.write("                    <td colspan=\"2\" align=\"center\">\n");
      out.write("                        <a href=\"IngresoPredial.jsp\"><button class=\"btn btn-primary\" type=\"button\" onclick=\"submit()\">Ingresar Nuevo Predio</button></a>\n");
      out.write("                        </td>  \n");
      out.write("                    \n");
      out.write("                    <tr> \n");
      out.write("                        <td colspan=\"2\" align=\"center\">\n");
      out.write("                            <a href=\"MenuAdministrativo.jsp\"><button class=\"btn btn-primary\" type=\"button\"  onclick=\"submit()\">Salir</button></td></a>\n");
      out.write("                    </tr>\n");
      out.write("                       \n");
      out.write("                    \n");
      out.write("                    \n");
      ...
      out.write("        <button class=\"btn btn-primary btn-sx\" type=\"button\">Confirm</button>\n");
      out.write("    </div>\n");
      out.write("\n");
      out.write("    <!-- I want another button here, center to the tile-->\n");
      out.write("\n");
      out.write("    <div class=\"pull-right\">\n");
      out.write("        <button class=\"btn btn-primary btn-xs pull-right\" type=\"button\">Decline</button>\n");
      out.write("    </div>\n");
      out.write("</div>\n");
      out.write("                    \n");
      out.write("                    \n");
